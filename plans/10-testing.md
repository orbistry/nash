...
- [x] Reconstruct boundaries in Nash from explicit choices and run the returned
  property thunk without regenerating; retain reduced trees and cache complete outcomes.
