...
impl DefaultFunction {
    /// Every runtime builtin, in declaration order.
    pub const ALL: &'static [Self] = &[
        ...
        Self::ModInteger,
        Self::EqualsInteger,
        Self::LessThanInteger,
        Self::LessThanEqualsInteger,
        Self::AppendByteString,
        Self::ConsByteString,
        Self::SliceByteString,
        Self::LengthOfByteString,
        Self::IndexByteString,
        Self::EqualsByteString,
        Self::LessThanByteString,
        Self::LessThanEqualsByteString,
        Self::Sha2_256,
        Self::Sha3_256,
        Self::Blake2b_256,
        Self::Keccak_256,
        Self::Blake2b_224,
        Self::VerifyEd25519Signature,
        Self::VerifyEcdsaSecp256k1Signature,
        Self::VerifySchnorrSecp256k1Signature,
        Self::AppendString,
        Self::EqualsString,
        Self::EncodeUtf8,
        Self::DecodeUtf8,
        ...
        Self::MkNilData,
        Self::MkNilPairData,
        Self::Bls12_381_G1_Add,
        Self::Bls12_381_G1_Neg,
        Self::Bls12_381_G1_ScalarMul,
        Self::Bls12_381_G1_Equal,
        Self::Bls12_381_G1_Compress,
        Self::Bls12_381_G1_Uncompress,
        Self::Bls12_381_G1_HashToGroup,
        Self::Bls12_381_G2_Add,
        Self::Bls12_381_G2_Neg,
        Self::Bls12_381_G2_ScalarMul,
        Self::Bls12_381_G2_Equal,
        Self::Bls12_381_G2_Compress,
        Self::Bls12_381_G2_Uncompress,
        Self::Bls12_381_G2_HashToGroup,
        Self::Bls12_381_MillerLoop,
        Self::Bls12_381_MulMlResult,
        Self::Bls12_381_FinalVerify,
        Self::IntegerToByteString,
        Self::ByteStringToInteger,
        Self::AndByteString,
        Self::OrByteString,
        Self::XorByteString,
        Self::ComplementByteString,
        Self::ReadBit,
        Self::WriteBits,
        Self::ReplicateByte,
        Self::ShiftByteString,
        Self::RotateByteString,
        Self::CountSetBits,
        Self::FindFirstSetBit,
        Self::Ripemd_160,
        Self::ExpModInteger,
        Self::DropList,
        Self::LengthOfArray,
        Self::ListToArray,
        Self::IndexArray,
        Self::Bls12_381_G1_MultiScalarMul,
        Self::Bls12_381_G2_MultiScalarMul,
        Self::InsertCoin,
        Self::LookupCoin,
        Self::UnionValue,
        Self::ValueContains,
