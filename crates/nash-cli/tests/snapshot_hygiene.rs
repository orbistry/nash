...
const CONSTRUCTED_FIXTURES: &[&str] = &[
    "solve__inference__qualified_annotation_keeps_context_only_types_and_reserves_their_names.snap",
    "can__kinds__alias_substitution_preserves_application_head_and_argument.snap",
    "can__kinds__annotation_kinds_keep_application_parameters_correlated.snap",
    "can__kinds__annotation_retains_one_storable_predicate.snap",
    "can__module__tests__to_public_alias_private_returns_none.snap",
    "can__module__tests__to_public_alias_public_passes_through.snap",
    "can__module__tests__to_public_union_closed_strips_ctors.snap",
    "can__module__tests__to_public_union_open_passes_through.snap",
    "can__module__tests__to_public_union_private_returns_none.snap",
