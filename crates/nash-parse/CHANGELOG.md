...
- [9fa1d0a7](https://github.com/orbistry/nash/commit/9fa1d0a7de4c416cbaa7e45b5b56702b80046119) Preserve parsed call endpoints and the complete outer infix expression region so
  assertion reports include closing delimiters in their original source text. — Thanks @MicroProofs!
- Updated dependencies: nash-source@0.8.0
...
- [28c946c](https://github.com/orbistry/nash/commit/28c946c2f331ce53748e2fa74662b85a4856c6ea) Accumulate function arguments and binary operators without cloning partial chains. Keep parser arena allocation linear in operator-chain length. — Thanks @MicroProofs!
